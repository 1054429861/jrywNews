...
<div class="content">
  <div id="focusslide" class="carousel slide" data-ride="carousel">
	...
	<div class="carousel-inner" role="listbox">
	  ...
	  <a href="#" target="_blank" title="今日要闻" >
	  <img src="../resources/home/images/side1.png" alt="今日要闻" class="img-responsive"></a>
	  </div>
	  <div class="item">
	  <a href="#" target="_blank" title="今日要闻" >
	  <img src="../resources/home/images//side2.png" alt="今日要闻" class="img-responsive"></a>
	  </div>
	</div>
  ...
  <a class="focus" href="../news/detail?id=${news.id }" title="${news.title }" target="_blank" ><img class="thumb" data-original="${news.photo }" src="${news.photo }" alt="${news.title }"  style="display: inline;"></a>
		...
		<p class="meta">
			...
			<span class="views"><i class="glyphicon glyphicon-eye-open" title="阅读量"></i> ${news.viewNumber }</span>
