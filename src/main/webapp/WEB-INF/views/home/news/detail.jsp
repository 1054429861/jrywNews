...
<div class="content">
  <header class="article-header">
	...
	<div class="article-meta"> 
		<span class="item article-meta-time">
	  		<time class="time" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="发表时间：${news.createTime }"><i class="glyphicon glyphicon-time"></i> <fmt:formatDate value="${news.createTime }" pattern="yyyy-MM-dd HH:mm:ss" timeZone="" /></time>
	  	</span>
	  	<span class="item article-meta-source" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="">
	  	...
	  	<span class="item article-meta-category" data-toggle="tooltip" data-placement="bottom" title="${news.title }" data-original-title="${news.title }">
	  		...
	  		<a href="../news/category_list?cid=${news.newsCategory.id }" title="${news.newsCategory.name }" >${news.newsCategory.name }</a>
	  	</span> 
	  	...
	  	<span class="item article-meta-comment" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="评论量${news.commentNumber }">
	  		<a href="#comment" class="glyphicon glyphicon-comment"></a>${news.commentNumber }
	  	</span> 
	 </div>
  </header>
  ...
  <div class="title" id="comment" name="comment">
	<h3>评论</h3>
  </div>
  <div id="respond">
		<form id="comment-form" name="comment-form" action="" method="POST">
			<div class="comment">
				...
				<input name="nickname"  id="nickname" class="form-control" value="${user.username }" size="22" placeholder="请登陆后评论" maxlength="15" autocomplete="off" tabindex="1" type="text" readonly="readonly" >
				<div class="comment-box">
					<textarea placeholder="发表您的评论" name="content" id="comment-textarea" cols="100%" rows="3" tabindex="3"></textarea>
