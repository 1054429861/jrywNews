    ...
    <nav class="navbar navbar-default" id="navbar">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <h1 class="logo hvr-bounce-in"><a href="/News/index/index" title="今日要闻新闻网站"><img
                        src="../resources/home/images/logo.png" alt="今日要闻新闻网站"></a></h1>
            </div>
		...
		<button class="btn btn-default btn-search" name="search" type="submit">搜索</button>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li><a data-cont="今日要闻新闻网站" title="今日要闻新闻网站" href="/News/index/index">首页</a></li>
                    <c:forEach items="${newsCategoryList }" var="newsCategory">
                        <li><a title="${newsCategory.name }"
                               href="../news/category_list?cid=${newsCategory.id }">${newsCategory.name }</a></li>
                    </c:forEach>
                </ul>
            </div>
        </div>
